...
public class Example {
  ...
  public static void main(String[] args) {
    List<Number> oldNumbers = List.of(123, 12.3, 12312512);
    System.out.println("Positive integers from " + oldNumbers + " are: "
        + restrictToPositiveIntegers(oldNumbers.stream()).toList());
    ...
    System.out.println("Positive integers from " + numbers + " are: "
        + restrictToPositiveIntegers(numbers.stream()).toList());
